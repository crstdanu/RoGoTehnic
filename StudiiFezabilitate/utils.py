...
from StudiiFezabilitate.Avize.Suceava import avize as suceava
...
def creeaza_fisier(lucrare_id, id_aviz):
    try:
        ...
        # BACĂU
            ...
            if avizCU.nume_aviz.nume == "Aviz ACET":
                return suceava.aviz_ACET(lucrare_id, id_aviz)
            elif avizCU.nume_aviz.nume == "Aviz NeoGas":
                return suceava.aviz_NeoGas(lucrare_id, id_aviz)
            else:
                return DocumentGenerationResult.error_result(
