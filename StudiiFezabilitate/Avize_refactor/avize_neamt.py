...
def aviz_HCL_Neamt(lucrare_id: int, id_aviz: int):
    """
    Aceasta functie genereaza documentatia necesara pentru avizul EE DELGAZ.
    Documentatia se depune pe email in format PDF, un singur fișier."""
    try:
        ...
        if firma.nume == "S.C. ROGOTEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/01. neamt/06. Aviz HCL - Neamt/Cerere HCL - ROGOTEHNIC.docx"
        elif firma.nume == "S.C. GENERAL TEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/01. neamt/06. Aviz HCL - Neamt/Cerere HCL - GENERAL TEHNIC.docx"
        elif firma.nume == "S.C. PROING SERV S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/01. neamt/06. Aviz HCL - Neamt/Cerere HCL - PROING SERV.docx"
        else:
            return DocumentGenerationResult.error_result(
                "Nu am gasit modelul de cerere pentru firma de proiectare selectata")

        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/01. neamt/06. Aviz HCL - Neamt/Citeste-ma.docx"
...
def aviz_ApaServ(lucrare_id: int, id_aviz: int):
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/07. Aviz ApaServ/Cerere ApaServ.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/07. Aviz ApaServ/Model email.docx"
...
def aviz_Luxten(lucrare_id: int, id_aviz: int):
    """
    Acest aviz se depune pe email astefel ca documentatia este in format pdf pentru a fi atasata emailului
    Fisierul 'Model email' contine informatii cu privire la adresa de email și continutul mesajului din email
    """
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/08. Aviz Luxten/Cerere Luxten.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/08. Aviz Luxten/Model email.docx"
...
def aviz_PMPN_Trafic(lucrare_id: int, id_aviz: int):
    """
    Acest aviz se depune pe email astefel ca documentatia este in format pdf pentru a fi atasata emailului
    Fisierul 'Model email' contine informatii cu privire la adresa de email și continutul mesajului din email
    """
    try:
        ...
        if firma.nume == "S.C. ROGOTEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/09. Aviz PMPN Trafic/Cerere PMPN Trafic - ROGOTEHNIC.docx"
        elif firma.nume == "S.C. GENERAL TEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/09. Aviz PMPN Trafic/Cerere PMPN Trafic - GENERAL TEHNIC.docx"
        elif firma.nume == "S.C. PROING SERV S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/09. Aviz PMPN Trafic/Cerere PMPN Trafic - PROING SERV.docx"
        else:
            return DocumentGenerationResult.error_result(
                "Nu am gasit modelul de cerere pentru firma de proiectare selectata")

        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/09. Aviz PMPN Trafic/Model email.docx"
...
def aviz_PMPN_Protocol_HCL(lucrare_id: int, id_aviz: int):
    """
    Acest aviz se depune pe email astefel ca documentatia este in format pdf pentru a fi atasata emailului
    Fisierul 'Model email' contine informatii cu privire la adresa de email și continutul mesajului din email
    """
    try:
        ...
        if firma.nume == "S.C. ROGOTEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/10. Aviz PMPN Protocol HCL/Cerere PMPN Protocol - ROGOTEHNIC.docx"
        elif firma.nume == "S.C. GENERAL TEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/10. Aviz PMPN Protocol HCL/Cerere PMPN Protocol - GENERAL TEHNIC.docx"
        elif firma.nume == "S.C. PROING SERV S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/10. Aviz PMPN Protocol HCL/Cerere PMPN Protocol - PROING SERV.docx"
        else:
            return DocumentGenerationResult.error_result(
                "Nu am gasit modelul de cerere pentru firma de proiectare selectata")

        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/10. Aviz PMPN Protocol HCL/Model email.docx"
...
def aviz_Publiserv(lucrare_id: int, id_aviz: int):
    """
    Acest aviz se depune pe email astefel ca documentatia este in format pdf pentru a fi atasata emailului
    Fisierul 'Model email' contine informatii cu privire la adresa de email și continutul mesajului din email
    """
    try:
        ...
        if firma.nume == "S.C. ROGOTEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/11. Aviz Publiserv/Cerere Publiserv - ROGOTEHNIC.docx"
        elif firma.nume == "S.C. GENERAL TEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/11. Aviz Publiserv/Cerere Publiserv - GENERAL TEHNIC.docx"
        elif firma.nume == "S.C. PROING SERV S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/11. Aviz Publiserv/Cerere Publiserv - PROING SERV.docx"
        else:
            return DocumentGenerationResult.error_result(
                "Nu am gasit modelul de cerere pentru firma de proiectare selectata")
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/11. Aviz Publiserv/Model email.docx"
...
def aviz_GN_PrismaServ(lucrare_id: int, id_aviz: int):
    """
    Acest aviz se depune pe email astefel ca documentatia este in format pdf pentru a fi atasata emailului
    Fisierul 'Model email' contine informatii cu privire la adresa de email și continutul mesajului din email
    La aceasta documentatie se adauga si CI-ul reprezentantului firmei de proiectare
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/12. Aviz GN PrismaServ/Cerere PrismaServ.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/12. Aviz GN PrismaServ/Model email.docx"
...
def aviz_Salubritate_Edil_Industry(lucrare_id: int, id_aviz: int):
    """
    Acest aviz se depune pe email astefel ca documentatia este in format pdf pentru a fi atasata emailului
    Fisierul 'Model email' contine informatii cu privire la adresa de email și continutul mesajului din email
    """
    try:
        ...
        if firma.nume == "S.C. ROGOTEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/13. Aviz Salubritate - Edil Industry/Cerere Edil - ROGOTEHNIC.docx"
        elif firma.nume == "S.C. GENERAL TEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/13. Aviz Salubritate - Edil Industry/Cerere Edil - GENERAL TEHNIC.docx"
        elif firma.nume == "S.C. PROING SERV S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/13. Aviz Salubritate - Edil Industry/Cerere Edil - PROING SERV.docx"
        else:
            return DocumentGenerationResult.error_result(
                "Nu am gasit modelul de cerere pentru firma de proiectare selectata")

        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/13. Aviz Salubritate - Edil Industry/Model email.docx"
...
def aviz_DIGI_Neamt(lucrare_id: int, id_aviz: int):
    """
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/14. Aviz DIGI - Neamt/Citeste-ma.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/14. Aviz DIGI - Neamt/Citeste-ma.docx"
...
def aviz_MApN_Neamt(lucrare_id: int, id_aviz: int):
    """
    Aceasta functie genereaza documentatia necesara pentru avizul MApN Neamt.
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/15. Aviz MApN - Neamt/Cerere MApN.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/15. Aviz MApN - Neamt/Citeste-ma.docx"
...
def aviz_GN_Mihoc_Oil(lucrare_id: int, id_aviz: int):
    """
    Aceasta functie genereaza documentatia necesara pentru avizul GN Mihoc Oil.
    Documentatia se depune pe email in format PDF, un singur fișier."""
    try:
        lucrare = Lucrare.objects.get(pk=lucrare_id)
        avizCU = AvizeCU.objects.get(pk=id_aviz)
        ...
        if firma.nume == "S.C. ROGOTEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/16. Aviz GN - Mihoc Oil/Cerere GN MIhoc - ROGOTEHNIC.docx"
        elif firma.nume == "S.C. GENERAL TEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/16. Aviz GN - Mihoc Oil/Cerere GN MIhoc - GENERAL TEHNIC.docx"
        elif firma.nume == "S.C. PROING SERV S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/16. Aviz GN - Mihoc Oil/Cerere GN MIhoc - PROING SERV.docx"
        else:
            return DocumentGenerationResult.error_result(
                "Nu am gasit modelul de cerere pentru firma de proiectare selectata")
        
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/16. Aviz GN - Mihoc Oil/Model email - Mihoc Oil.docx"
...
def aviz_TransElectrica_Neamt(lucrare_id: int, id_aviz: int):
    """
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/17 . Aviz TransElectrica - Neamt/Cerere Transelectrica.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/17 . Aviz TransElectrica - Neamt/Citeste-ma.docx"
...
def aviz_TransGaz_Neamt(lucrare_id: int, id_aviz: int):
    """
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/18. Aviz TransGaz - Neamt/Cerere TransGaz.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/18. Aviz TransGaz - Neamt/Model email.docx"
...
def aviz_ANIF_Neamt(lucrare_id: int, id_aviz: int):
    """
    Aceasta functie genereaza documentatia necesara pentru avizul ANIF Neamt.
    Documentatia se depune pe email in format PDF, un singur fișier."""
    try:
        lucrare = Lucrare.objects.get(pk=lucrare_id)
        avizCU = AvizeCU.objects.get(pk=id_aviz)
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/19. Aviz ANIF - Neamt/Cerere ANIF.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/19. Aviz ANIF - Neamt/Model email.docx"
...
def studiu_geotehnic_Neamt(lucrare_id: int, id_aviz: int):
    """
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/20. Studiu geotehnic/Model email.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/02.neamt/20. Studiu geotehnic/Model email.docx"
