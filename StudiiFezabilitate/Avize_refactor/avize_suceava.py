...
def aviz_MApN_Suceava(lucrare_id: int, id_aviz: int):
    """
    Aceasta functie genereaza documentatia necesara pentru avizul MApN Suceava.
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/05. suceava/10. Aviz MApN - Suceava/Cerere MApN.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/05. suceava/10. Aviz MApN - Suceava/Citeste-ma.docx"
...
def aviz_TransElectrica_Suceava(lucrare_id: int, id_aviz: int):
    """
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/05. suceava/11 . Aviz TransElectrica - Suceava/Cerere Transelectrica.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/05. suceava/11 . Aviz TransElectrica - Suceava/Citeste-ma.docx"
...
def aviz_TransGaz_Suceava(lucrare_id: int, id_aviz: int):
    """
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/05. suceava/12. Aviz TransGaz - Suceava/Cerere TransGaz.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/05. suceava/12. Aviz TransGaz - Suceava/Model email.docx"
...
def aviz_ANIF_Suceava(lucrare_id: int, id_aviz: int):
    """
    Aceasta functie genereaza documentatia necesara pentru avizul ANIF Suceava.
    Documentatia se depune pe email in format PDF, un singur fișier."""
    try:
        lucrare = Lucrare.objects.get(pk=lucrare_id)
        avizCU = AvizeCU.objects.get(pk=id_aviz)
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/05. suceava/13. Aviz ANIF - Suceava/Cerere ANIF.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/05. suceava/13. Aviz ANIF - Suceava/Model email.docx"
...
def studiu_geotehnic_Suceava(lucrare_id: int, id_aviz: int):
    """
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/05. suceava/14. Studiu geotehnic/Model email.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/05. suceava/14. Studiu geotehnic/Model email.docx"
...
def aviz_Natura_2000_Suceava(lucrare_id: int, id_aviz: int):
    """
    Aceasta functie genereaza documentatia necesara pentru avizul NATURA 2000.
    Documentatia se depune pe email in format PDF, un singur fișier."""
    try:
        lucrare = Lucrare.objects.get(pk=lucrare_id)
        avizCU = AvizeCU.objects.get(pk=id_aviz)
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/05. suceava/15. Natura 2000 - Suceava/Cerere Natura 2000.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/05. suceava/15. Natura 2000 - Suceava/Model email.docx"
