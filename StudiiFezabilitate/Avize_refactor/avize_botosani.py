...
def aviz_HCL_Botosani(lucrare_id: int, id_aviz: int):
    """
    Aceasta functie genereaza documentatia necesara pentru avizul HCL din Botosani.
    Documentatia se depune pe email in format PDF, un singur fișier."""
    try:
        lucrare = Lucrare.objects.get(pk=lucrare_id)
        avizCU = AvizeCU.objects.get(pk=id_aviz)
...
def aviz_MApN_Botosani(lucrare_id: int, id_aviz: int):
    """
    Aceasta functie genereaza documentatia necesara pentru avizul MApN Botosani.
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/09. Aviz MApN - Botosani/Cerere MApN.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/09. Aviz MApN - Botosani/Citeste-ma.docx"
...
def aviz_Modern_Calor(lucrare_id: int, id_aviz: int):
    """
    Aceasta functie genereaza documentatia necesara pentru avizul Termoficare Modern Calor SA din Botosani.
    ...
    try:
        ...
        if firma.nume == "S.C. ROGOTEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/10. Aviz Modern Calor SA/Cerere TMC - ROGOTEHNIC.docx"
        elif firma.nume == "S.C. GENERAL TEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/10. Aviz Modern Calor SA/Cerere TMC - GENERAL TEHNIC.docx"
        elif firma.nume == "S.C. PROING SERV S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/10. Aviz Modern Calor SA/Cerere TMC - PROING SERV.docx"
        else:
            return DocumentGenerationResult.error_result(
                "Nu am gasit modelul de cerere pentru firma de proiectare selectata")

        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/10. Aviz Modern Calor SA/Citeste-ma.docx"
        ...
        try:
            ...
            # --- 4. Generare Document Final --- #
            path_document_final = simple.genereaza_document_final_STANDARD_PRINT(
                lucrare, avizCU, cerere_pdf_path, cu, beneficiar, temp_dir)
            fisiere_generate.append(path_document_final)
...
def acord_CJ_Botosani(lucrare_id: int, id_aviz: int):
    """
    Aceasta functie genereaza documentatia necesara pentru un Acord CJ Botosani.
    Documentatia se depune pe email in format PDF, un singur fișier."""
    try:
        lucrare = Lucrare.objects.get(pk=lucrare_id)
        avizCU = AvizeCU.objects.get(pk=id_aviz)
        ...
        if firma.nume == "S.C. ROGOTEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/11. Acord CJ Botosani/Cerere CJB - ROGOTEHNIC.docx"
        elif firma.nume == "S.C. GENERAL TEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/11. Acord CJ Botosani/Cerere CJB - GENERAL TEHNIC.docx"
        elif firma.nume == "S.C. PROING SERV S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/11. Acord CJ Botosani/Cerere CJB - PROING SERV.docx"
        else:
            return DocumentGenerationResult.error_result(
                "Nu am gasit modelul de cerere pentru firma de proiectare selectata")
        
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/11. Acord CJ Botosani/Model email - CJ Botosani.docx"
...
def acord_Club_Sportiv_Botosani(lucrare_id: int, id_aviz: int):
    """
    Aceasta functie genereaza documentatia necesara pentru un Acord Club Sportiv Botosani.
    Documentatia se depune pe email in format PDF, un singur fișier."""
    try:
        lucrare = Lucrare.objects.get(pk=lucrare_id)
        avizCU = AvizeCU.objects.get(pk=id_aviz)
        ...
        if firma.nume == "S.C. ROGOTEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/12. Acord Club Sportiv Botosani/Cerere CSB - ROGOTEHNIC.docx"
        elif firma.nume == "S.C. GENERAL TEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/12. Acord Club Sportiv Botosani/Cerere CSB - GENERAL TEHNIC.docx"
        elif firma.nume == "S.C. PROING SERV S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/12. Acord Club Sportiv Botosani/Cerere CSB - PROING SERV.docx"
        else:
            return DocumentGenerationResult.error_result(
                "Nu am gasit modelul de cerere pentru firma de proiectare selectata")
        
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/12. Acord Club Sportiv Botosani/Model email - CS Botosani.docx"
...
def aviz_principiu_Biroul_Rutier_Botosani(lucrare_id: int, id_aviz: int):
    """
    Aceasta functie genereaza documentatia necesara pentru un Aviz principiu - Biroul Rutier Botosani.
    Documentatia se depune pe email in format PDF, un singur fișier."""
    try:
        lucrare = Lucrare.objects.get(pk=lucrare_id)
        avizCU = AvizeCU.objects.get(pk=id_aviz)
        ...
        if firma.nume == "S.C. ROGOTEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/13. Aviz principiu Biroul Rutier - Botosani/Cerere BRB - ROGOTEHNIC.docx"
        elif firma.nume == "S.C. GENERAL TEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/13. Aviz principiu Biroul Rutier - Botosani/Cerere BRB - GENERAL TEHNIC.docx"
        elif firma.nume == "S.C. PROING SERV S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/13. Aviz principiu Biroul Rutier - Botosani/Cerere BRB - PROING SERV.docx"
        else:
            return DocumentGenerationResult.error_result(
                "Nu am gasit modelul de cerere pentru firma de proiectare selectata")

        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/13. Aviz principiu Biroul Rutier - Botosani/Model email - Biroul Rutier - Botosani.docx"
        ...
        # 1.2 Verificare fișiere încărcate
        result = simple.verifica_fisiere_incarcate_Biroul_Rutier_Botosani(
            cu, firma, reprezentant, beneficiar)
        if result is not None and not result.is_success():
            return result
        ...
        try:
            ...
            # --- 4. Generare Document Final --- #
            path_document_final = simple.genereaza_document_final_aviz_principiu_Biroul_Rutier_Botosani(
                lucrare, avizCU, cerere_pdf_path, cu, beneficiar, temp_dir,)
            fisiere_generate.append(path_document_final)
...
def aviz_TransElectrica_Botosani(lucrare_id: int, id_aviz: int):
    """
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/14 . Aviz TransElectrica - Botosani/Cerere Transelectrica.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/14 . Aviz TransElectrica - Botosani/Citeste-ma.docx"
...
def aviz_TransGaz_Botosani(lucrare_id: int, id_aviz: int):
    """
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/15. Aviz TransGaz - Botosani/Cerere TransGaz.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/15. Aviz TransGaz - Botosani/Model email.docx"
...
def aviz_ANIF_Botosani(lucrare_id: int, id_aviz: int):
    """
    Aceasta functie genereaza documentatia necesara pentru avizul ANIF Botosani.
    Documentatia se depune pe email in format PDF, un singur fișier."""
    try:
        lucrare = Lucrare.objects.get(pk=lucrare_id)
        avizCU = AvizeCU.objects.get(pk=id_aviz)
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/16. Aviz ANIF - Botosani/Cerere ANIF.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/16. Aviz ANIF - Botosani/Model email.docx"
...
def studiu_geotehnic_Botosani(lucrare_id: int, id_aviz: int):
    """
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/17. Studiu geotehnic/Model email.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/04. botosani/17. Studiu geotehnic/Model email.docx"
