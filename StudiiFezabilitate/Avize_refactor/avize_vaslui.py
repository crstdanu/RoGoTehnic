...
def aviz_APM_Vaslui(lucrare_id: int, id_aviz: int):
    """
    Aceasta functie genereaza documentatia necesara pentru avizul APM din Vaslui.
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/01. Aviz APM - Vaslui/Cerere_APM_Vaslui.docx"
        model_notificare = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/01. Aviz APM - Vaslui/Notificare_APM_Vaslui.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/01. Aviz APM - Vaslui/Model_email_APM_Vaslui.docx"
...
def aviz_EE_Delgaz_Vaslui(lucrare_id: int, id_aviz: int):
    """
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/02. Aviz EE Delgaz - Vaslui/Cerere EE Delgaz - Vaslui.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/02. Aviz EE Delgaz - Vaslui/Cerere EE Delgaz - Vaslui.docx"
...
def aviz_GN_Delgaz_Vaslui(lucrare_id: int, id_aviz: int):
    """
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/03. Aviz GN Delgaz - Vaslui/Cerere GN Delgaz - Vaslui.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/03. Aviz GN Delgaz - Vaslui/Model email - GN Delgaz Vaslui.docx"
...
def aviz_Orange_Vaslui(lucrare_id: int, id_aviz: int):
    """
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/04. Aviz Orange - Vaslui/01. Cerere Orange - Vaslui.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/04. Aviz Orange - Vaslui/Citeste-ma.docx"
...
def aviz_Cultura_Vaslui(lucrare_id: int, id_aviz: int):
    pass


def aviz_HCL_Vaslui(lucrare_id: int, id_aviz: int):
    """
    Aceasta functie genereaza documentatia necesara pentru avizul EE DELGAZ.
    Documentatia se depune pe email in format PDF, un singur fișier."""
    try:
        ...
        if firma.nume == "S.C. ROGOTEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/01. vaslui/06. Aviz HCL - Vaslui/Cerere HCL - ROGOTEHNIC.docx"
        elif firma.nume == "S.C. GENERAL TEHNIC S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/01. vaslui/06. Aviz HCL - Vaslui/Cerere HCL - GENERAL TEHNIC.docx"
        elif firma.nume == "S.C. PROING SERV S.R.L.":
            model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/01. vaslui/06. Aviz HCL - Vaslui/Cerere HCL - PROING SERV.docx"
        else:
            return DocumentGenerationResult.error_result(
                "Nu am gasit modelul de cerere pentru firma de proiectare selectata")

        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/01. vaslui/06. Aviz HCL - Vaslui/Citeste-ma.docx"
...
def aviz_DIGI_Vaslui(lucrare_id: int, id_aviz: int):
    """
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/07. Aviz DIGI - Vaslui/Citeste-ma.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/07. Aviz DIGI - Vaslui/Citeste-ma.docx"
...
def aviz_MApN_Vaslui(lucrare_id: int, id_aviz: int):
    """
    Aceasta functie genereaza documentatia necesara pentru avizul MApN Vaslui.
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/08. Aviz MApN - Vaslui/Cerere MApN.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/08. Aviz MApN - Vaslui/Citeste-ma.docx"
...
def aviz_TransElectrica_Vaslui(lucrare_id: int, id_aviz: int):
    """
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/09 . Aviz TransElectrica - Vaslui/Cerere Transelectrica.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/09 . Aviz TransElectrica - Vaslui/Citeste-ma.docx"
...
def aviz_TransGaz_Vaslui(lucrare_id: int, id_aviz: int):
    """
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/10. Aviz TransGaz - Vaslui/Cerere TransGaz.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/10. Aviz TransGaz - Vaslui/Model email.docx"
...
def aviz_ANIF_Vaslui(lucrare_id: int, id_aviz: int):
    """
    Aceasta functie genereaza documentatia necesara pentru avizul ANIF Vaslui.
    Documentatia se depune pe email in format PDF, un singur fișier."""
    try:
        lucrare = Lucrare.objects.get(pk=lucrare_id)
        avizCU = AvizeCU.objects.get(pk=id_aviz)
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/11. Aviz ANIF - Vaslui/Cerere ANIF.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/11. Aviz ANIF - Vaslui/Model email.docx"
...
def studiu_geotehnic_Vaslui(lucrare_id: int, id_aviz: int):
    """
    ...
    try:
        ...
        model_cerere = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/12. Studiu geotehnic/Model email.docx"
        model_detalii = "StudiiFezabilitate/Avize_refactor/modele_cereri/06. vaslui/12. Studiu geotehnic/Model email.docx"
