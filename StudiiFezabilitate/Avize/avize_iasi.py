...
import StudiiFezabilitate.Avize.functii_iasi as x
import os
...
def aviz_APM(lucrare_id, id_aviz):
    try:
        ...
        errors = x.verifica_campuri_necesare_APM(
