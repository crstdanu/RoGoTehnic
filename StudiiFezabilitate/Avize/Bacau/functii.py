...
def verifica_campuri_necesare_RAJA(lucrare, firma, reprezentant, cu, beneficiar, contact, model_cerere, model_detalii):
    """
    Verifică dacă toate câmpurile necesare pentru generarea avizului sunt prezente
    """
    errors = x.check_required_fields([
        ...
        (reprezentant.cale_ci,
            "Nu se poate genera avizul - lipsește CI-ul Reprezentantului firmei de proiectare"),
        # Campurile astea doua sunt in plus
        (firma.cale_certificat,
         "Nu se poate genera avizul - lipsește Certificatul de înregistrare al firmei de proiectare"),
        (cu.cale_plan_situatie_la_scara,
            "Nu se poate genera avizul - lipseste Planul de situatie la scara in format .pdf"),
        # Câmpuri necesae
        (firma.nume, "Nu se poate genera avizul - lipsește numele firmei de proiectare"),
        (firma.adresa, "Nu se poate genera avizul - lipsește Adresa firmei de proiectare"),
        (firma.localitate, "Nu se poate genera avizul - lipsește Localitatea firmei de proiectare"),
...
def verifica_campuri_necesare_extra(lucrare, firma, reprezentant, cu, beneficiar, contact, model_cerere, model_detalii):
    """
    Verifică dacă toate câmpurile necesare pentru generarea avizului sunt prezente
    """
    errors = x.check_required_fields([
        ...
        (cu.cale_memoriu_tehnic_CU,
            "Nu se poate genera avizul - lipsește Memoriul tehnic anexă CU"),
        (firma.cale_certificat,
            "Nu se poate genera avizul - lipsește Certificatul de inregistrare al firmei de proiectare"),
        (reprezentant.cale_ci,
            "Nu se poate genera avizul - lipsește Certificatul de inregistrare al firmei de proiectare"),
