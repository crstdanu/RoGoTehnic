...
def verifica_campuri_necesare_APM(lucrare, firma, reprezentant, cu, beneficiar, contact):
    ...
    model_cerere = r"E:\NEW_python\RGT\StudiiFezabilitate\Avize\modele_cereri\00. APM\Cerere_APM.docx"
    model_notificare = r"E:\NEW_python\RGT\StudiiFezabilitate\Avize\modele_cereri\00. APM\Notificare.docx"
    model_email = r"E:\NEW_python\RGT\StudiiFezabilitate\Avize\modele_cereri\00. APM\Model email.docx"
    ...
    if not os.path.exists(model_email):
        return DocumentGenerationResult.error_result(
            "Nu găsesc modelul pentru Emailul APM")
...
def genereaza_document_final_APM(cerere_pdf_path, notificare_pdf_path, cu, beneficiar, temp_dir):
    """
...
def genereaza_email_APM(lucrare, beneficiar, cu, contact, temp_dir):
    """
    ...
    email_choices = {
        'Iași': "office@apmis.anpm.ro",
        'Neamț': "office@apmnt.anpm.ro",
        'Suceava': "office@apmsv.anpm.ro",
        'Botoșani': "office@apmbt.anpm.ro",
        'Vaslui': "office@apmvs.anpm.ro",
    }

    email = email_choices.get(lucrare.judet.nume)
